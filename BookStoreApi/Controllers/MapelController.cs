...
{
    private readonly BooksService _mapelService;

    public MapelController(BooksService mapelService) =>
    ...
    {
        await _mapelService.CreateAsync(newBook);
    ...
    public async Task<IActionResult> Update(string id, Book updatedBook)
    {
        ...
        await _mapelService.UpdateAsync(id, updatedBook);
