...
{
    private readonly BooksService _presensiMengajarService;

    public PresensiMengajarController(BooksService presensiMengajarService) =>
    ...
    {
        await _presensiMengajarService.CreateAsync(newBook);
    ...
    public async Task<IActionResult> Update(string id, Book updatedBook)
    {
        ...
        await _presensiMengajarService.UpdateAsync(id, updatedBook);
