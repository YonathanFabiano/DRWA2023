...
{
    private readonly BooksService _kelasService;

    public KelasController(BooksService kelasService) =>
    ...
    {
        await _kelasService.CreateAsync(newBook);
    ...
    public async Task<IActionResult> Update(string id, Book updatedBook)
    {
        ...
        await _kelasService.UpdateAsync(id, updatedBook);
